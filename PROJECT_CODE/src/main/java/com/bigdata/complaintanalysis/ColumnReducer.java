...
public class ColumnReducer {
	...
	public void reduceColumn (String args1, String args2) throws Exception {
		if (args1 == null && args2 == null) {
			System.err.println("ColumnReducer::main(): Don't have input and output paths {Arguments: [Input CSV File] [Output Sequence Directory] }");
		}
		...
		FileWriter writer = new FileWriter(outputDir + "SortedData.csv");
		...
		while (true) {
			...
			if (columns.length != 14) {
				System.out.println("ColumnReducer::main(): Invalid Line");
			}
			...
			catch (IOException e) {System.out.println("ColumnReducer::main(): Error writing File"); }
			count ++;
		}
		reader.close();
		writer.close();
